...
```json
{
  ...
  "results": [
    {
      ...
      "key_insights": "Public contracts should not expose raw Notion structures.",
  ...
  "message": "Archive lookup completed by query."
}
```
...
* `message` is present as a route-specific string
